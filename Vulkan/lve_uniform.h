...
namespace lve {
	...
	public:
		...
		void updateUniformBuffer(uint32_t currentImage, VkExtent2D extent, const glm::mat4& modelMatrix, const glm::mat4& view, const glm::mat4& proj, glm::vec3 cameraPos);
